...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="text-gray-600 body-font relative">
        ...
        @if ($errors->any())
            <div class="lg:w-1/3 bg-orange-800 rounded-lg p-8 flex flex-col mx-auto w-full mt-10 relative z-10 shadow-md">
                <span class="text-red-300 font-bold">Sorry, we ran into an issue!</span>
                <ul class="text-white">
